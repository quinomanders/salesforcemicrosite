...
<div class="anchorNav2" id="bank"></div>
			...
			<div class="window">
				<div class="holder active" id="integrationnews">
					...
					<div class="container text-block text-center">
							...
							<h4 class="sol text-center">
							Ease of transition to new order capture software
							</h4>
							<h4 class="sol text-center">
							Accessible worldwide
							</h4>
							<h4 class="sol text-center">
							Optimized flow for order processes
							</h4>
	...
	<div class="anchorNav2" id="oil"></div>
		<div class="block"
		style="background-color: #434493; background-image: url(); padding: 0;">
			...
			<div class="window">
				<div class="holder active" id="integrationnews">
					...
					<div class="container text-block text-center">
							...
							<h4 class="sol text-center">
							Expected benefits: $5 - 11 million
							</h4>
							<h4 class="sol text-center">
							Projects successfully delivered on time and on budget, improved customer and staff experience
							</h4>
							<h4 class="sol text-center">
							Improved collaboration and access to data/knowledge from multiple devices (phone, tablet, ipad)
							</h4>
